...
if(isset($_POST['update_product'])){
    ...
    details = '$details', price = '$price' WHERE id = '$update_p_id'") or die('query failed');
    ...
    if(!empty($image)){
        if($image_size > 2000000){
            ...
            mysqli_query($conn," UPDATE `products` SET image = '$image'
...
<section class="update-product">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <textarea name="details" class="box" required placeholder="update product details" 
        cols="30" rows="10" > <?php echo $fetch_products['details']; ?></textarea>
